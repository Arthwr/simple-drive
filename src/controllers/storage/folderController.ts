...
const postNewFolder = asyncHandler<AuthenticatedRequest>(async (req, res, next) => {
  ...
  const redirectPath = parentPublicFolderId ? `/dashboard/${parentPublicFolderId}` : '/dashboard';
